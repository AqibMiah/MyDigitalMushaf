        ...
        <div className="mb-6 sm:mb-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm sm:text-base border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
        </div>
          ...
          {filteredSurahs.map((surah) => (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-blue-600 font-bold text-sm sm:text-base">{surah.number}</span>
                <span className="text-lg sm:text-xl text-blue-900">{surah.name}</span>
              </div>
